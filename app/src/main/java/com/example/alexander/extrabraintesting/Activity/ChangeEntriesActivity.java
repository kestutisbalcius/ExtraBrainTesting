...
public class ChangeEntriesActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Spinner adapter
        CreateProject.setAdapter(new ArrayAdapter<String>(ChangeEntriesActivity.this, android.R.layout.simple_spinner_dropdown_item, Charginglist));
        CreateCharging.setAdapter(new ArrayAdapter<String>(ChangeEntriesActivity.this, android.R.layout.simple_spinner_dropdown_item, Projectlist));
    }
