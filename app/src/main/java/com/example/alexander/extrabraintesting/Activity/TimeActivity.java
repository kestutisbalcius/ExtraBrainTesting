    ...
    public void onSectionAttached(int number) {
        switch (number) {
            case 1:
                ...
                Intent IntentSuccess = new Intent(this, TimeActivity.class); // where you want to go with the intent "MainActivity"
                startActivity(IntentSuccess);
                break;
            case 2:
                mTitle = getString(R.string.title_Tasks);
                Log.d("if success","finish");
                IntentSuccess = new Intent(this, TimeActivity.class);
                startActivity(IntentSuccess);
                break;
            case 3:
